...
namespace VetMed
{
    public partial class Form1 : Form
    {
        ...
        string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=;Integrated Security=True"; // Include filepath after AttachDbFilename=
        private string twilioAccountSid = ""; // Twilio ID (Omitted for Security, include own)
        private string twilioAuthToken = ""; // Twilio Auth Token (Omitted for Security, include own)
        private string twilioPhoneNumber = "+"; // Twilio Phone number used (Omitted for Security, include own)
